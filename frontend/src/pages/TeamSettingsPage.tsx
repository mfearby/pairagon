...
import { Stack, Title, Group, TextInput, Button, Card, Text, ActionIcon, Anchor } from '@mantine/core'
...
export default function TeamSettingsPage() {
  ...
  useEffect(() => {
    api.getTeam(id).then(setTeam).catch(() => notifications.show({ message: 'Failed to load team', color: 'red' }))
  }, [id])
